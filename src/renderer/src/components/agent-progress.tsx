...
export const AgentProgress: React.FC<AgentProgressProps> = ({ progress, className }) => {
  ...
  return (
    <div className={cn(
      ...
      {/* Progress Steps */}
      <div className="flex flex-col gap-2 max-h-36 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
      ...
      {/* Final content display for completed tasks */}
      {isComplete && progress.finalContent && (
        <div className="mt-2 p-2 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-700">
          ...
          <div className="text-xs text-green-700 dark:text-green-400 mt-1 line-clamp-3">
